window.STEWARD_PROJECTS = {
  ...
  wd4well: {
    ...
    summary: "A long-running water-supply project to place production well SD2-1 into service with a prefabricated treatment and control building, related site work, storage, piping, treatment equipment, monitoring, startup and testing.",
    location: "SD2 property / Water District No. 4, North Castle", department: "Water & Sewer Operations / Water District No. 4",
    costLabel: "Combined awarded contracts", costValue: "$2,699,643", costNote: "Awarded contract value: $1,423,158 for the treatment building plus $1,276,485 for site work. This is not a final actual-spending figure.",
    story:{
      context:"The project began with wetland and test-well work in 2016 and moved through drilling, pump testing, environmental review, repeated Health Department comments and design revisions. The treatment building will integrate the new well into the operating system with booster pumps, ultraviolet and chlorine disinfection, microfiltration, turbidity and chlorine monitoring, SCADA controls, lighting and climate control.",
      people:"The Water Department identifies Armonk, North White Plains, Quarry Heights, Whippoorwill and Windmill Farm among the communities it serves. WD4 customers are the people most directly affected because the project is intended to strengthen water-supply capacity and reliability, while the district is responsible for repaying project financing.",
      discussion:"The Town Board authorized bidding after Health Department approval in July 2024. It accepted the $1.423 million treatment-building bid but rejected the first round of site-work bids after prices came in higher than expected and WSP identified unclear or unusually priced items. Revised specifications produced an additional bidder and lowered the site-work award by $167,515 compared with the original low bid. The Board then authorized an internal General Fund loan as a lower-cost alternative to outside short-term borrowing.",
      next:"Complete construction, startup and regulatory approval; publish the completion date and actual expenditures; and confirm the final loan principal, term, interest rate and method for allocating repayment among WD4 customers."
    },
    process:[
      {date:"2016–2020",title:"Site review, drilling and pump testing",description:"The Town completed wetland review, sought drilling approvals, rebid drilling and performed a 72-hour pump test for the new source.",state:"complete"},
      {date:"2021–July 2024",title:"Treatment design and regulatory review",description:"WSP and the Town responded to multiple Health Department comments and revised the design. Health Department project approval was issued July 8, 2024.",state:"complete"},
      {date:"July–December 2024",title:"Bidding authorized and bids opened",description:"The Town Board authorized bidding July 24. Treatment-building and initial site-work bids were opened December 4.",state:"complete"},
      {date:"January 22, 2025",title:"Building bid accepted; site work rejected",description:"The Town accepted Engineered Fluid's $1,423,158 treatment-building bid and rejected all six initial site-work bids so the specifications could be clarified and rebid.",state:"complete"},
      {date:"April–May 2025",title:"Rebid produces lower site-work award",description:"Seven bids were opened April 17. The Town awarded the $1,276,485 site-work contract to Pepitto Construction after WSP reviewed pricing and references.",state:"complete"},
      {date:"May 28, 2025",title:"Internal financing authorized",description:"The project timeline records a Town Board resolution for an approximately $2.7 million internal loan from the General Fund to WD4.",state:"complete"},
      {date:"August 2026",title:"Construction underway",description:"The Water Department's project timeline identifies construction as ongoing. Completion, startup and final spending remain to be documented.",state:"active"}
    ],
    costBreakdown:[
      ["Treatment/control building — Engineered Fluid, Inc.",1423158,"Awarded January 2025"],
      ["Site work — Pepitto Construction Company, Inc.",1276485,"Awarded May 2025"]
    ],
    funding:[
